...
class Proposer
{
 private:
  ...
  // [V] : These 2 fields need to be stable. Read from log in the constructor.
  ...
  std::map<uint64_t, std::string>
      accepted_proposals_;  // This would come from log read, just war for now
